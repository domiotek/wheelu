...
export default function ChangePasswordPortal({ onSuccess, token }: IProps) {
	...
	const submitMutation = useMutation<
		null,
		API.Auth.ChangePassword.IEndpoint["error"],
		API.Auth.ChangePassword.IRequestData
	>({
		mutationFn: (data) =>
			callAPI<API.Auth.ChangePassword.IEndpoint>(
				"POST",
	...
	return (
		<Card sx={{ width: "100%", maxWidth: 420, m: 2, p: { xs: 2, sm: 4 } }}>
			<Stack alignItems="center" gap="0.5em">
				...
				<FormContainer
					FormProps={{ className: commonClasses.Form }}
					onSuccess={onSubmit}
				...
				>
					...
					>
						<TextFieldElement
							...
							required
							error={
								formContext.formState.errors.password !=
								undefined
							}
							helperText={
								formContext.formState.errors.password !=
						...
						<TextFieldElement
							...
							required
							error={
								formContext.formState.errors.cpassword !=
								undefined
							}
							helperText={
								formContext.formState.errors.cpassword !=
