...
export default class AuthService {
	...
	public static translateSignInErrorCode(errCode: API.Auth.SignIn.IEndpoint["errCodes"]) {
		switch(errCode) {
			case "AccountNotActivated":
				return React.createElement(
					React.Fragment,null, 
					"Twoje konto jest nieaktywne. Jeśli email nie dotarł, spróbuj ", 
					React.createElement(Link, {component: RouterLink, to: "/resend-activation-link"} as any, "wysłać go ponownie"), ".");
