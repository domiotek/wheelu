...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20241018121956_InstructorChangeRequests")]
    partial class InstructorChangeRequests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 10, 18, 12, 19, 55, 214, DateTimeKind.Utc).AddTicks(7156)
                        });
                });
