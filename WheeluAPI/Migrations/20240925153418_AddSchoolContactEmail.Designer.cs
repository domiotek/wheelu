...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20240925153418_AddSchoolContactEmail")]
    partial class AddSchoolContactEmail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 9, 25, 15, 34, 16, 509, DateTimeKind.Utc).AddTicks(8492)
                        });
                });
