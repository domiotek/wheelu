...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20241012214650_MakeRideInSlotOptional")]
    partial class MakeRideInSlotOptional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 10, 12, 21, 46, 48, 964, DateTimeKind.Utc).AddTicks(2214)
                        });
                });
