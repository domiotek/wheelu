...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20240907124940_AddNearbySchoolsToCity")]
    partial class AddNearbySchoolsToCity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 9, 7, 12, 49, 40, 40, DateTimeKind.Utc).AddTicks(1281)
                        });
                });
