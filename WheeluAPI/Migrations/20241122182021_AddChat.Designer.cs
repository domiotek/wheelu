...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20241122182021_AddChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WheeluAPI.Models.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WheeluAPI.Models.Chat.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WheeluAPI.Models.Chat.LastReadMessage", b =>
                {
                    ...
                    b.HasKey("ChatMemberId", "ChatMessageId");

                    b.HasIndex("ChatMessageId");

                    b.HasIndex("ConversationId");

                    b.ToTable("LastReadMessage");
                });
            ...
            modelBuilder.Entity("WheeluAPI.Models.Course", b =>
                {
                    ...
                    b.Property<string>("CourseProgressJSON")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WheeluAPI.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 11, 22, 18, 20, 20, 936, DateTimeKind.Utc).AddTicks(8561)
                        });
                });
            ...
            modelBuilder.Entity("ConversationUser", b =>
                {
                    b.HasOne("WheeluAPI.Models.Chat.Conversation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WheeluAPI.Models.Chat.ChatMessage", b =>
                {
                    b.HasOne("WheeluAPI.models.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WheeluAPI.Models.Chat.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("WheeluAPI.Models.Chat.LastReadMessage", b =>
                {
                    b.HasOne("WheeluAPI.models.User", "ChatMember")
                        .WithMany()
                        .HasForeignKey("ChatMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WheeluAPI.Models.Chat.ChatMessage", "ChatMessage")
                        .WithMany()
