...
namespace WheeluAPI.Migrations
{
    ...
    [Migration("20240914151114_AddInstructors")]
            ...
            modelBuilder.Entity("WheeluAPI.Models.SchoolInstructor", b =>
                {
                    ...
                    b.Property<int>("MaximumConcurrentStudends")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WheeluAPI.models.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadDate = new DateTime(2024, 9, 14, 15, 11, 12, 706, DateTimeKind.Utc).AddTicks(2542)
                        });
                });
